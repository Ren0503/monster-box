...
class BlogEdit extends Component {
    ...
    render() {
        ...
        return (
            <div className="blog">
                {this.renderAlert()}
                <h2 className="mb-5">Edit Yout Blog</h2>
...
function mapStateToProps(state, ownProps) {
    return { initialValues: ownProps.blog }
}

export default connect(mapStateToProps, { updateBlog })(BlogEdit)